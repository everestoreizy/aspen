...
public class TempData {
    ...
    public static void addExamples() {
        ...
        Timeslot ts1 = new Timeslot(new Xdate(18, 6, 2020), "Summer day 1");
        ...
        Timeslot ts2 = new Timeslot(new Xdate(19, 6, 2020), "Summer day 2");
        ...
        Timeslot ts3 = new Timeslot(new Xdate(19, 6, 2020), "Summer day 2 after dinner");
