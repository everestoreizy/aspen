...
import com.oreizy.everest.xaspen.structure.Board;
import com.oreizy.everest.xaspen.structure.Task;
import com.oreizy.everest.xaspen.structure.Timeslot;
import com.oreizy.everest.xaspen.structure.User;
...
public class HTMLRender {
    ...
    public String render(){
        ...
        switch(cx){
                case "com.oreizy.everest.xaspen.structure.Board":   return renderBoard( (Board) data );
                case "com.oreizy.everest.xaspen.structure.User":    return renderUser( (User) data);
                default:   
                    System.out.println("Render switch failed " + cx);
                    return null;
        }
    }
    ...
    private String renderBoard(Board data){
        ...
        for(Timeslot ts : data.timeslots){
            ...
            //System.out.println("in timeslot " + ts.title);
            
            for(Task ta : ts.tasks){
                
                //System.out.println("in task " + ta.title);
                ...
                System.out.println("about to model");
